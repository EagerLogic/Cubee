 ...
 * @author dipacs
 */
public class AlignRightExp extends AExpression<Integer> {
    ...
    public AlignRightExp(AComponent parent, AComponent child) {
        this(parent, child, 0);
    }
    
    public AlignRightExp(AComponent parent, AComponent child, int translateX) {
        this.parent = parent;
        this.child = child;
    ...
    public AlignRightExp(AComponent parent, AComponent child, IntegerProperty translateXProperty) {
        this.parent = parent;
        this.child = child;
        this.translateX = 0;
    ...
    public Integer calculate() {
        ...
        return ((parent.clientWidthProperty().get() - child.boundsWidthProperty().get())) - tx;
    }
