...
public final class MouseDownEventArgs extends EventArgs {
	...
	public MouseDownEventArgs(int screenX, int screenY, int x, int y, boolean altPressed, boolean ctrlPressed, boolean shiftPressed, boolean metaPressed, Object sender) {
		super(sender);
